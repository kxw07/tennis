...
public class TennisTest {
    ...
    @Test
    public void given_a_and_b_scores_two_then_return_thirty_all () {
        aScoresTimes(2);
        bScoresTimes(2);
    ...
    @Test
    public void given_deuce_when_b_scores_two_then_return_win_b () {
        aScoresTimes(3);
        bScoresTimes(3);
        bScoresTimes(2);
    ...
    @Test
    public void given_deuce_when_a_and_b_scores_one_then_return_deuce () {
        aScoresTimes(3);
        bScoresTimes(3);
        aScoresTimes(1);
        bScoresTimes(1);
